...
from keras.layers import Input, Conv2D, MaxPooling2D, UpSampling2D, Cropping2D, ZeroPadding2D, Activation#, BatchNormalization
...
#if you want to test three models ensemble, just do like this: pred = (pred_1+pred_2+pred_3)/
